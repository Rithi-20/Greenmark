                                            ...
                                            <img
                                                src={(() => {
                                                    ...
                                                    if (log.image_ipfs_hash?.startsWith('Qm') || log.image_ipfs_hash?.length > 40) {
                                                        return `https://gateway.pinata.cloud/ipfs/${log.image_ipfs_hash}`;
                                                    }
                                                    if (log.image_ipfs_hash?.startsWith('/uploads')) {
                                                        return `${BASE_URL}${log.image_ipfs_hash}`;
                                                    }
                                                    return log.image_ipfs_hash ? `${BASE_URL}${log.image_ipfs_hash.startsWith('/') ? '' : '/'}${log.image_ipfs_hash}` : 'https://images.unsplash.com/photo-1592150621344-82d67abb9dfa?w=400';
                                                })()}
